...
const LoginForm: React.FC = () => {
  ...
  return (
      <form className="d-flex flex-column justify-content-center"
          ...
          <input type="password" id="password" className="SecondaryBtn" style={{fontWeight: "lighter"}} placeholder="12345" onChange={(event: React.ChangeEvent<HTMLInputElement>) => {
          ...
          <div className='text-center mb-5'>
            {/* <PrimaryBtn title="Најави се" onClick={() => setView("albums")} btnClass={"PrimaryBtn w-100"} backgroundColor={"black"} color='white' border='none' height='40px' /> */}
            <PrimaryBtn title="Најави се" btnClass={"PrimaryBtn w-100"} backgroundColor={"black"} color='white' border='none' height='40px' />
