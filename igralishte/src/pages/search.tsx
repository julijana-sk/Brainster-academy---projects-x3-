...
// interface Props {
//   searchedBlogsItemsData: BlogType[];
//   searchedProductsItemsData: ProductType[];
// }
// const Search: NextPage<Props> = ({searchedBlogsItemsData, searchedProductsItemsData}) => {
//   return (
//     <>
//       <Head>
...
//               {searchedBlogsItemsData.length > 0 ? ( searchedBlogsItemsData.map((searchedBlog) => {
//               return (
//                 <div className="col-4">
//                 <BlogItem key={searchedBlog.id} {...searchedBlog}/>
//                   </div>
//                   ) 
//                 })
//                 ) : (
